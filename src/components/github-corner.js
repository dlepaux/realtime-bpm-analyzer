...
export default class extends React.Component {
  render() {
    return (
      <a href="https://github.com/dlepaux/realtime-bpm-analyzer" className="github-corner" aria-label="View source on GitHub">
        <svg width="80" height="80" viewBox="0 0 250 250" style={{fill: '#7f7f7f', color: '#22272e', position: 'absolute', top: '56px', border: 0, right: 0}} aria-hidden="true">
