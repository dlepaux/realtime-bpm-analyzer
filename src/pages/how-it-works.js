        ...
        <Container className="mt-3">
          ...
          <div className="text-center mb-3">
            <div className="btn-group">
              <button type="button" className="btn btn-primary" click="toggleStart" v-if="!this.state.start">
                <i className="bi bi-play-circle"/> Play
              </button>
              <button type="button" className="btn btn-dark" click="togglePause" v-if="this.state.start">
              ...
              <button type="button" className="btn btn-dark" click="toggleStart" disabled={!this.state.start}>
          ...
          <section className="d-flex flex-column mb-1">
            ...
            <PcmGraph showThresold className="mb-3"/>
            <p>
