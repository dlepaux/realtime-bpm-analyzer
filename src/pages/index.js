...
function HomePage() {
  return <>
    ...
    <Container className="pb-3">
      <p class="text-center">
        <img src="/img/allegro-project-transparent.png" class="img-fluid"/>
      </p>
      ...
      <h2 class="mt-3">Contribution, Community & Support</h2>
      <p>
